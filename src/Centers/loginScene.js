...
export default class login extends Component {
    ...
    login =()=>{
        ...
        var url = 'http://m249126q62.zicp.vip/user/login?username='+dataForm.username+'&&password='+dataForm.password+'';
        var opts = {
            method:"GET",
        };
        if (dataForm.username != '' && dataForm.password != '') {
            // if (this.username == dataForm.username && this.password == dataForm.password) {
                fetch(url, opts)
                    .then((response) => {
                    ...
                    console.log(json)
                        ...
                        }//跳转到注册过的Home界面',ToastAndroid.SHORT);
                    })
                    .catch((e) => {
                        console.log(e);
                    })
