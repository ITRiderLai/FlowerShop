            ...
            navigationOptions:() =>({
                ...
                tabBarIcon:({focused,tintColor})=>(
                    <TabBarItem
                        ...
                        selectedImage={require('./images/homecolor.png')}
                    />
                )
            }),
        },
            ...
            navigationOptions:() =>({
                ...
                tabBarIcon:({focused,tintColor})=>(
                    <TabBarItem
                        tintColor={tintColor}
                        focused = {focused}
                        normalImage={require('./images/sort.png')}
                        selectedImage={require('./images/sortcolor.png')}
                    />
                )
            }),
        },
            ...
            navigationOptions:() =>({
                ...
                tabBarIcon:({focused,tintColor})=>(
                    <TabBarItem
                        tintColor={tintColor}
                        focused = {focused}
                        normalImage={require('./images/order.png')}
                        selectedImage={require('./images/ordercolor.png')}
                    />
                )
            }),
        },
            ...
            navigationOptions:() =>({
                ...
                tabBarIcon:({focused,tintColor})=>(
                    <TabBarItem
                        ...
                        selectedImage={require('./images/cartcolor.png')}
                    />
                )
            }),
        },
        Centers: {
            screen: createStackNavigator({ Centers: Centers }),
            navigationOptions:() =>({
                tabBarLabel:"个人",
                tabBarIcon:({focused,tintColor})=>(
                    <TabBarItem
                        ...
                        selectedImage={require('./images/minecolor.png')}
                    />
                )
            })
        },
